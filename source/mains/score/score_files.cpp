...
long articulation_to_lilypond_buf(t_notation_obj *r_ob, long articulation_ID, char **buf){
    ...
    switch (articulation_ID) {
        case k_ARTICULATION_STACCATO: sprintf(*buf, "-."); break;
        case k_ARTICULATION_ACCENT: sprintf(*buf, "->"); break;
        case k_ARTICULATION_PORTATO: sprintf(*buf, "--"); break;
        case k_ARTICULATION_TRILL: sprintf(*buf, "\trill"); break;
        // trillNatural, trillFlat, and trillSharp don't exist in Lilypond
        ...
        case k_ARTICULATION_ACCENT_STACCATO: sprintf(*buf, "->-."); break;
        case k_ARTICULATION_ACCENT_PORTATO: sprintf(*buf, "->--"); break;
        case k_ARTICULATION_PORTATO_STACCATO: sprintf(*buf, "---."); break;
        ...
        case k_ARTICULATION_MARTELLATO_STACCATO: sprintf(*buf, "-.\marcato"); break;
        ...
        case k_ARTICULATION_LEFT_HAND_PIZZICATO: sprintf(*buf, "-+"); break;
